...
public class AwsCognitoIdp{
    ...
    static final String USERNAME = "youryouryour@namemail.com";
    static final String PASSWORD = "passPassPassword";
    static final String CLIENTID = "clicliclientID01";
    static final String USERPOOLID = "ap-northeast-1_123yyyXXX";
	...
	HashMap tokens = cognito_idp();
	System.out.println(tokens.get("IdToken"));
    ...
    private BigInteger A;
    private String userPoolID = USERPOOLID;
    private String clientId = CLIENTID;
    private String secretKey;
    private String region;

    public static HashMap<String, String> cognito_idp() {
	HashMap<String, String> tokens = new HashMap<String, String>();
	String id_token = null;
	String access_token = null;
	String refresh_token = null;
	AwsCognitoIdp cog = new AwsCognitoIdp();
	InitiateAuthRequest initiateAuthRequest = cog.initiateUserSrpAuthRequest(USERNAME);
	...
	try {
		...
		RespondToAuthChallengeRequest challengeRequest = cog.userSrpAuthRequest(initiateAuthResult, PASSWORD);
		RespondToAuthChallengeResult result = cognitoIdentityProvider.respondToAuthChallenge(challengeRequest);
		id_token = result.getAuthenticationResult().getIdToken();
		access_token = result.getAuthenticationResult().getAccessToken();
		refresh_token = result.getAuthenticationResult().getRefreshToken();
	    }
  ...
  private byte[] getPasswordAuthenticationKey(String userId, String userPassword,
                                              BigInteger B, BigInteger salt) {
